...
Raw data on the number and distribution of proposals submitted to the three investigated funding schemes in the Life Sciences is provided in Table \@ref(tab:tab1). 
...
Coefficient tables for the multivariate linear probability model and from the logistic regression model, both modeling the binary outcome “at least one positive word”, can be found in the appendix (tables \@ref(tab:tab-gender-linear-stratify) and \@ref(tab:tab-gender-binary-stratify)). 
