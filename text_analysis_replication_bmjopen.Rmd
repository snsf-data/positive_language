...
The distributions of the positive words across all three funding schemes are provided in Figure S2 included in the [online supplement](https://snsf-data/positive_language/online_supplement/index.html). Figure \@ref(fig:fig-distribution-number-poswords) shows the distribution of the number of positive words per funding scheme and gender of the corresponding applicant. We see that the majority of proposals include at least one positive term in their title or abstract.
