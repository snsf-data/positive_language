---
title: "Online reproducible supplement"
subtitle: "Text analysis of self-promotional language across genders in grant proposals"
header-includes:
   - \usepackage{dcolumn}
   - \usepackage{booktabs}
   - \usepackage{makecell}
...
```{r tab-gender-linear-stratify, message = FALSE, warning = FALSE, cache = F}
